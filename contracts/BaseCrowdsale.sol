...
/**
 * @title BaseCrowdSale
 * @title AffiliateCoin.io base crowdsale contract for managing a token crowdsale.
 */
contract BaseCrowdsale is Pausable {
    ...
    * @param _maxTokensAmount ICO AFL capacity (in AFL)
    ...
    */
    ...
    /**
     * Buy AFL. Check minBuyableAmount and tokenRate.
